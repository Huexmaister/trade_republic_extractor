...
1.  Abre el archivo `index.html` de este proyecto en tu navegador web (Chrome, Firefox, Edge).
2.  Arrastra y suelta tu archivo PDF en el área designada o haz clic para seleccionarlo.
3.  Espera unos segundos mientras la herramienta procesa el documento.
4.  ¡Listo! Navega por las pestañas para ver tus transacciones, gráficos y reportes fiscales.
