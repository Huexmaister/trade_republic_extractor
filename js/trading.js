  ...
  const html = `
    <section class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
      ...
      <div class="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
        <p class="font-semibold text-slate-900">Erläuterung & Beta-Hinweis</p>
        <ul class="mt-2 space-y-1 list-disc pl-5">
          ...
          <li class="pt-2"><strong>Disclaimer:</strong> Los cálculos se basan en la ingeniería inversa de los extractos y pueden tener un margen de error. Se presupone que el cálculo de impuestos de la app es correcto; si ese cálculo es erróneo, los resultados aquí mostrados también lo serán. Verifique siempre con sus documentos oficiales.</li>
        </ul>
      </div>
    </section>
  `;
