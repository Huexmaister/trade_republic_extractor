...
# ============================================================================
#  Script para iniciar el entorno de desarrollo en macOS y Linux
# ============================================================================
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    # Para Linux (intenta con Chrome/Chromium, luego Firefox)
    if command -v google-chrome &> /dev/null; then
        google-chrome --incognito "http://localhost:$PORT"
    elif command -v chromium-browser &> /dev/null; then
        chromium-browser --incognito "http://localhost:$PORT"
    elif command -v firefox &> /dev/null; then
        firefox -private-window "http://localhost:$PORT"
    else
        xdg-open "http://localhost:$PORT" # Fallback
    fi
    ...
    echo "   Por favor, abre manualmente http://localhost:$PORT en tu navegador."
fi
